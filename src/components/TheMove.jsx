...
function SouvenirTile() {
  ...
  return (
    <div className="relative flex aspect-[4/5] flex-col items-center justify-center overflow-hidden rounded-sm border border-ink/15 bg-gradient-to-br from-cyan/20 via-bone/5 to-gold/20 p-6 text-center">
      <span className="text-[10px] uppercase tracking-[0.3em] text-ink/50">
        Official Fan Souvenir
      </span>
      <span className="headline mt-4 text-4xl text-ink/90 md:text-5xl">
      ...
      <span className="mt-6 text-[10px] uppercase tracking-[0.2em] text-ink/40">
      ...
      <div className="mx-auto max-w-6xl px-6 py-20 md:py-28">
        ...
        <div className="mt-10 grid items-stretch gap-6 md:grid-cols-2">
          ...
          <div className="flex flex-col">
            ...
            <div
              className="rounded-sm border border-ink/15 p-5"
