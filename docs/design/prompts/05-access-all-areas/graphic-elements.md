...
**Payload:** the AAA laminate that lets outsiders in keeps residents out. Sponsor = ACCESS: ALL AREAS / subtag (UNLESS YOU LIVE HERE). Number from a pass/barcode ID. Hem = the 2010 displacement receipt.
...
official badge / credential aesthetic,
white background --ar 16:9 --style raw
```
...
bold condensed sans-serif, hi-vis orange on black rectangle,
event-credential / tournament-sponsor aesthetic,
white background --ar 16:9 --style raw
```
...
small caps under the main mark, bone text on black,
fine-print disclaimer aesthetic,
white background --ar 16:9 --style raw
```
...
gold border, black field, hi-vis chevron edge,
...
clean condensed credential lettering, bone on black,
...
tiny monospace fine-print, bone on black,
official credential microprint, hem / care-label placement,
white background --ar 16:9 --style raw
```
...
```
two small graphics:
a maker band reading "ZONE: SECURED",
and a World Cup trophy silhouette restyled as a turnstile / a checkpoint barrier,
hi-vis-orange and gold line art on black,
access-control aesthetic, collar / sleeve accent,
white background --ar 16:9 --style raw
```
