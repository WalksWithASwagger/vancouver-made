...
**Palette:** ink `#0E0E0E` · redaction bar `#141414` (gloss on matte) · bone `#EDE6D8` · CLASSIFIED stamp red `#C0392B`.
...
### Prompt 2: Matte-on-matte black study
```
material study of matte black fabric with glossy black bars across it,
the bars only visible where raking light hits,
tonal black-on-black, subtle sheen difference,
minimalist, tactile, almost invisible,
--ar 4:5 --style raw
```

### Prompt 3: CLASSIFIED stamp
```
macro of a red "CLASSIFIED" rubber stamp impression on black paper,
faded ink edges, official seal aesthetic,
stark red on near-black,
--ar 4:5 --style raw
```

### Prompt 4: Black-bloc silhouette
```
figure in all-black protest dress photographed at distance,
solid black silhouette, anonymous, uniform,
overcast street, documentary protest aesthetic,
reads as pure black mass,
--ar 4:5 --style raw
```
