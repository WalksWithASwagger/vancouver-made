...
Data: `src/data/clubs.js#pump-and-dump-fc`.

> **TV read:** a sexy, hypebeast blackout "city pride" third kit. **Street read:** a
> wearable indictment of a city that treated housing as a speculative asset while
...
that moves the price; the residents are the retail buyers left holding the bag after
...
The commercial inventory is a fake offering memorandum.
- **Sponsor patch (chest):** `PUMP & DUMP CAPITAL` over `WE WIN IF YOU LIVE HERE OR NOT`.
- **Sleeve cuff:** `EXIT LIQUIDITY`.
- **Crest motto ribbon:** `INFLATE. EXTRACT. ABANDON.`
- **Hem fine print:** `FORWARD-LOOKING STATEMENTS` / `NOT FINANCIAL ADVICE`.
...
- ~2,500 unsold Metro Vancouver condos / foreign money skewing the market / "freak
  show" unaffordability (CBC 2025; BIV; Macleans / Ian Young). *Cite with date;
  confirm current figures.* (`AL-PD-002`)
- City World Cup cost ~$320–338M core, plus $67–74M other public-sector, ~$242M
  combined safety/security. *Confirm latest figures before publishing.* (`AL-PD-003`)
